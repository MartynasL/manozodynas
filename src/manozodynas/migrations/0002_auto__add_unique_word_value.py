...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Word', fields ['value']
        db.create_unique(u'manozodynas_word', ['value'])


    def backwards(self, orm):
        # Removing unique constraint on 'Word', fields ['value']
        db.delete_unique(u'manozodynas_word', ['value'])
    ...
    models = {
        ...
        u'manozodynas.translation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'translation': ('django.db.models.fields.CharField', [], {'max_length': "'50'"}),
