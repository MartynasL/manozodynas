...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Translation.vote'
        db.add_column(u'manozodynas_translation', 'vote',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Translation.vote'
        db.delete_column(u'manozodynas_translation', 'vote')
